...
import { StaffOrderTrend } from "@/types/analytics";

interface StaffOrderTrendChartProps {
  data: StaffOrderTrend[];
}
...
export default function StaffOrderTrendChart({
  data,
}: StaffOrderTrendChartProps) {
